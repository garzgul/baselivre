...
public class jiEditeurModification extends javax.swing.JInternalFrame {
...
//    private Vector ved;
    ...
    public jiEditeurModification(int idEdit, InterfaceRoot ir) {
        this.ir = ir;
        this.sqlConnexion = ir.SqlConnexion();
        this.idEdit = idEdit;
        edit = remplissage(this.idEdit);
        initComponents();
    ...
    /**
     * Modification d'un "Editeur" dans la base SQL "baselivre" Connexion a la
     * base, Insertion des attributs de la nouvelle entree, Fermeture de la
     * connexion
     *
     * @param evt
     */
    ...
    private void jBValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBValiderActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE editeur set editeur_nom = '"+jtfnomEditeur.getText()+"', "
                    + " editeur_pays = '"+jtfpaysEditeur.getText()+"', editeur_adresse = '"+jtfadresseEditeur.getText()+"',"
                    + " editeur_cp = '"+jtfcpEditeur.getText()+"', editeur_ville = '"+jtfvilleEditeur.getText()+"', "
                    + " editeur_tel = '"+jtftelEditeur.getText()+"', editeur_email = '"+jtfemailEditeur.getText()+"' "
                    + "WHERE  id_editeur=" + idEdit + " AND editeur_actif= 1";

            
            
            if (JOptionPane.showConfirmDialog(this,"Confirmez vous la modification de cet Editeur ?")== JOptionPane.OK_OPTION){
    ...
    private Editeur remplissage(int idEdit) {
        ...
        try {
            ...
            String query = "SELECT * FROM editeur WHERE editeur.id_editeur = "+this.idEdit+";";
